...
/**
 * Allows you to specify a number of configuration options when setting up a {@link al.shkurti.pullmenu.library.PullMenuLayout}.
 */
public final class Options {

    /* Default configuration values */
    private static final int DEFAULT_HEADER_LAYOUT = R.layout.default_header;
    private static final float DEFAULT_REFRESH_SCROLL_DISTANCE = 0.55f;
    private static final boolean DEFAULT_REFRESH_ON_UP = false;
    private static final int DEFAULT_REFRESH_MINIMIZED_DELAY = 1 * 1000;
    private static final boolean DEFAULT_REFRESH_MINIMIZE = false;
    ...
    public static class Builder {
        ...
        /**
         * @return the built {@link al.shkurti.pullmenu.library.Options} instance.
         */
